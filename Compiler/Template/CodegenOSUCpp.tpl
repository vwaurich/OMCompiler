...
case SIMCODE(modelInfo=modelInfo as MODELINFO(__)) then
  ...
  let()= textFile(osuModelCppFile(simCode, extraFuncs, extraFuncsDecl, "",guid, FMUVersion), 'OMCpp<%fileNamePrefix%>OSU.cpp')
...
::=
  match simCode
    ...
    *****************************************************************************/
    ...
    #include "OMCpp<%fileNamePrefix%>OSU.cpp"
...
case SIMCODE(modelInfo=MODELINFO(__)) then
  ...
  FMI2_Export const char* fmi2GetTypesPlatform()
  {
   ...
   {
        return osi_fmi2_set_debug_logging(c, loggingOn, nCategories, categories);
   }
   ...
   {
       return osi_fmi2_instantiate(instanceName, fmuType, fmuGUID, fmuResourceLocation, functions, visible, loggingOn);
   }

   FMI2_Export void fmi2FreeInstance(fmi2Component c)
   {
      osi_fmi2_free_instance(c);
   }
    ...
    {
        return osi_fmi2_setup_experiment(c, toleranceDefined, tolerance, startTime, stopTimeDefined, stopTime);
    }

    FMI2_Export fmi2Status fmi2EnterInitializationMode(fmi2Component c)
    {
       return osi_fmi2_enter_initialization_mode(c);
    }

    FMI2_Export fmi2Status fmi2ExitInitializationMode(fmi2Component c)
    {
        return osi_fmi2_exit_initialization_mode(c);
    }

    FMI2_Export fmi2Status fmi2Terminate(fmi2Component c)
    {
        return osi_fmi2_terminate(c);
    }

    FMI2_Export fmi2Status fmi2Reset(fmi2Component c)
    {
        return osi_fmi2_reset(c);
    }

    FMI2_Export fmi2Status fmi2GetReal(fmi2Component c, const fmi2ValueReference vr[],size_t nvr, fmi2Real value[])
    {
        return osi_fmi2_get_real(c, vr, nvr, value);
    }

    FMI2_Export fmi2Status fmi2GetInteger(fmi2Component c, const fmi2ValueReference vr[],size_t nvr, fmi2Integer value[])
    {
        return osi_fmi2_get_integer(c, vr, nvr, value);
    }

    FMI2_Export fmi2Status fmi2GetBoolean(fmi2Component c, const fmi2ValueReference vr[],size_t nvr, fmi2Boolean value[])
    {
        return osi_fmi2_get_boolean(c, vr, nvr, value);
    }

    FMI2_Export fmi2Status fmi2GetString(fmi2Component c, const fmi2ValueReference vr[],size_t nvr, fmi2String value[])
    {
        return osi_fmi2_get_string(c, vr, nvr, value);
    }

    FMI2_Export fmi2Status fmi2SetReal(fmi2Component c, const fmi2ValueReference vr[], size_t nvr, const fmi2Real value[])
    {
        return osi_fmi2_set_real(c, vr, nvr, value);
    }

    FMI2_Export fmi2Status fmi2SetInteger(fmi2Component c, const fmi2ValueReference vr[],size_t nvr, const fmi2Integer value[])
    {
        return osi_fmi2_set_integer(c, vr, nvr, value);
    }

    FMI2_Export fmi2Status fmi2SetBoolean(fmi2Component c, const fmi2ValueReference vr[],size_t nvr, const fmi2Boolean value[])
    {
        return osi_fmi2_set_boolean(c, vr, nvr, value);
    }

    FMI2_Export fmi2Status fmi2SetString(fmi2Component c, const fmi2ValueReference vr[], size_t nvr, const fmi2String value[])
    {
        return osi_fmi2_set_string(c, vr, nvr, value);
    }

    FMI2_Export fmi2Status fmi2GetFMUstate(fmi2Component c, fmi2FMUstate* FMUstate)
    {
        return osi_fmi2_get_fmu_state(c, FMUstate);
    }

    FMI2_Export fmi2Status fmi2SetFMUstate(fmi2Component c, fmi2FMUstate FMUstate)
    {
        return osi_fmi2_set_fmu_state(c, FMUstate);
    }

    FMI2_Export fmi2Status fmi2FreeFMUstate(fmi2Component c, fmi2FMUstate* FMUstate)
    {
        return osi_fmi2_free_fmu_state(c, FMUstate);
    }

    FMI2_Export fmi2Status fmi2SerializedFMUstateSize(fmi2Component c, fmi2FMUstate FMUstate,size_t* size)
    {
        return osi_fmi2_serialized_fmu_state_size(c, FMUstate, size);
    }

    FMI2_Export fmi2Status fmi2SerializeFMUstate(fmi2Component c, fmi2FMUstate FMUstate,fmi2Byte serializedState[], size_t size)
    {
        return osi_fmi2_serialize_fmu_state(c, FMUstate, serializedState, size);
    }
    ...
    {
        return osi_fmi2_de_serialize_fmu_state(c, serializedState, size, FMUstate);
    }
    ...
    {
        return osi_fmi2_get_directional_derivative(c, vUnknown_ref, nUnknown, vKnown_ref, nKnown, dvKnown, dvUnknown);
    }

    FMI2_Export fmi2Status fmi2EnterEventMode(fmi2Component c)
    {
        return osi_fmi2_enter_event_mode(c);
    }

    FMI2_Export fmi2Status fmi2NewDiscreteStates(fmi2Component  c,fmi2EventInfo* fmiEventInfo)
    {
        return osi_fmi2_new_discrete_state(c, fmiEventInfo);
    }

    FMI2_Export fmi2Status fmi2EnterContinuousTimeMode(fmi2Component c)
    {
        return osi_fmi2_enter_continuous_time_mode(c);
    }
...
case SIMCODE(modelInfo=MODELINFO(__), makefileParams=MAKEFILE_PARAMS(__), simulationSettingsOpt = sopt) then
  ...
  # /TP - Use C++ Compiler
  !IF "$(PCH_FILE)" == ""
  CFLAGS=  $(SYSTEM_CFLAGS) /DRUNTIME_STATIC_LINKING /I"<%makefileParams.omhome%>/include/omc/cpp/" /I"<%makefileParams.omhome%>/include/omc/OSI/" /I"<%makefileParams.omhome%>/include/omc/c/fmi2/" /I. <%makefileParams.includes%>  /I"$(BOOST_INCLUDE)" /I"$(UMFPACK_INCLUDE)" /I"$(SUNDIALS_INCLUDE)" /DNOMINMAX /TP /DNO_INTERACTIVE_DEPENDENCY <%additionalCFlags_MSVC%>
  !ELSE
  ...
  CDFLAGS = /ZI
  !IF "$(PCH_FILE)" == ""
  LDSYSTEMFLAGS=  /link /DLL  /LIBPATH:"<%makefileParams.omhome%>/lib/<%getTriple()%>/omc/cpp/msvc" /LIBPATH:"<%makefileParams.omhome%>/lib/<%getTriple()%>/omc/msvc" /LIBPATH:"<%makefileParams.omhome%>/lib/<%getTriple()%>/omc/msvc/debug"  /LIBPATH:"<%makefileParams.omhome%>/bin" /LIBPATH:"$(BOOST_LIBS)"  OMCppExtensionUtilities_static.lib OMCppModelicaUtilities_static.lib  OMCppOSU.lib   OMCppDataExchange_static.lib  OMCppSystem_static.lib   OMCppMath_static.lib  OMCppOMCFactory.lib  WSock32.lib Ws2_32.lib
  !ELSE
  LDSYSTEMFLAGS=  /link /DLL  /LIBPATH:"<%makefileParams.omhome%>/lib/<%getTriple()%>/omc/cpp/msvc" /LIBPATH:"<%makefileParams.omhome%>/lib/<%getTriple()%>/omc/msvc" /LIBPATH:"<%makefileParams.omhome%>/lib/<%getTriple()%>/omc/msvc/debug"  /LIBPATH:"<%makefileParams.omhome%>/bin" /LIBPATH:"$(BOOST_LIBS)"  OMCppExtensionUtilities_static.lib OMCppModelicaUtilities_static.lib  OMCppOSU.lib    OMCppDataExchange_static.lib  OMCppSystem_static.lib  OMCppMath_static.lib  OMCppOMCFactory.lib   $(PCH_LIB)  WSock32.lib Ws2_32.lib
  !ENDIF
...
case "gcc" then
    match simCode
        case SIMCODE(modelInfo=MODELINFO(__), makefileParams=MAKEFILE_PARAMS(__), simulationSettingsOpt = sopt) then
            ...
            CFLAGS=$(CFLAGS_BASED_ON_INIT_FILE) -Winvalid-pch $(FMU_CFLAGS) -DFMU_BUILD -DRUNTIME_STATIC_LINKING -I"$(OMHOME)/include/omc/cpp" -I"$(OMHOME)/include/omc/OSI/" -I"$(OMHOME)/include/omc/c/fmi2/"  -I"$(UMFPACK_INCLUDE)" -I"$(SUNDIALS_INCLUDE)" -I"$(BOOST_INCLUDE)" <%makefileParams.includes ; separator=" "%> <%additionalCFlags_GCC%>
            ...
            OMCPP_LIBS=-lOMCppSystem_static  -lOMCppOSU -lOMCppDataExchange_static -lOMCppExtensionUtilities_static -lOMCppModelicaUtilities_static    -lOMCppMath_static
            ...
            LIBS=$(OMCPP_LIBS) $(MODELICA_EXTERNAL_LIBS) $(BASE_LIB) $(EXTRA_LIBS) -L$(BOOST_LIBS) -l$(BOOST_SYSTEM_LIB) -l$(BOOST_FILESYSTEM_LIB)
            ...
            <%\t%>zip -r "<%modelName%>.fmu" modelDescription.xml binaries resources
            endif
   ...
   let fileNamePrefixx = fileNamePrefix
    ...
    match makefileParams.platform
      ...
      case  "linux64" then
        ...
        #!/bin/sh
        <%preRunCommandLinux%>
        <%execCommandLinux%> OMCppOSUSimulation <%execParameters%>  <%outputParameter%> $*
        >>
      case  "win32"
      case  "win64" then
        <<

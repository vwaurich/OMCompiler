...
class osi_me;
class OSUSystem: public IContinuous, public IEvent, public IStepEvent, public IStateSelection, public ITime, public ISystemProperties , public ISystemInitialization, public IMixedSystem, public IWriteOutput, public SystemDefaultImplementation
{
public:
...
private:
	...
	bool addValueReference(fmi2_import_variable_t* v, out_vars_vr_t& output_value_references, out_vars_vr_t& param_value_references,

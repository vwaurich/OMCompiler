...
SimSettings OMCFactory::readSimulationParameter(int argc, const char* argv[])
{
     ...
     SimSettings settings = {solver,linSolver,nonLinSolver,starttime,stoptime,stepsize,1e-24,0.01,tolerance,resultsfilename,timeOut,outputPointType,logSettings,nlsContinueOnError,solverThreads,outputFormat,emitResults,osu_name,osu_path,init_file_path};

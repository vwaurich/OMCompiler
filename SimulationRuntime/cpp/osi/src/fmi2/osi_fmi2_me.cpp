...
#include <fmi2/detail/osi_fmi2_log.h>
#include <fmi2/detail/osi_fmi2_wrapper.h>
#include "fmi2Functions.h"


extern "C" {

fmi2Component osi_fmi2_instantiate(fmi2String instanceName,
                               fmi2Type   fmuType,
                               fmi2String fmuGUID,
                               ...
                               fmi2Boolean                  loggingOn)
{
	...
	{
        component = osi_fmi2_me_instantiate( instanceName, fmuType, fmuGUID,fmuResourceLocation, functions, visible,loggingOn);
	}
...
fmi2Status osi_fmi2_set_debug_logging(fmi2Component c,fmi2Boolean  loggingOn,size_t nCategories,const fmi2String categories[])
{
...
void osi_fmi2_free_instance(fmi2Component c)
{
    if (((fmi2_me_t*)c)->fmu_type == fmi2ModelExchange)
	{
            osi_fmi2_me_free_instance(c);
...
fmi2Status osi_fmi2_setup_experiment(fmi2Component c,
...
fmi2Status osi_fmi2_enter_initialization_mode(fmi2Component c)
{
    OSU *osu = reinterpret_cast<OSU*>(c);
...
fmi2Status osi_fmi2_exit_initialization_mode(fmi2Component c)
{
	OSU *osu = reinterpret_cast<OSU*>(c);
...
fmi2Status osi_fmi2_terminate(fmi2Component c)
{
    OSU *osu = reinterpret_cast<OSU*>(c);
...
fmi2Status osi_fmi2_reset(fmi2Component c)
{
...
fmi2Status osi_fmi2_get_real(fmi2Component c, const fmi2ValueReference vr[],
...
fmi2Status osi_fmi2_get_integer(fmi2Component c, const fmi2ValueReference vr[],
...
fmi2Status osi_fmi2_get_boolean(fmi2Component c, const fmi2ValueReference vr[],
...
fmi2Status osi_fmi2_get_string(fmi2Component c, const fmi2ValueReference vr[],
...
fmi2Status osi_fmi2_set_real(fmi2Component c, const fmi2ValueReference vr[],
...
fmi2Status osi_fmi2_set_integer(fmi2Component c, const fmi2ValueReference vr[],
...
fmi2Status osi_fmi2_set_boolean(fmi2Component c, const fmi2ValueReference vr[],
...
fmi2Status osi_fmi2_set_string(fmi2Component c, const fmi2ValueReference vr[],
...
fmi2Status osi_fmi2_get_fmu_state(fmi2Component c, fmi2FMUstate* FMUstate) {
    OSU *osu = reinterpret_cast<OSU*>(c);
    LOG_CALL(osu, "fmi2GetFMUstate not implemented");
    return fmi2Error;
}

fmi2Status osi_fmi2_set_fmu_state(fmi2Component c, fmi2FMUstate FMUstate) {
    OSU *osu = reinterpret_cast<OSU*>(c);
    LOG_CALL(osu, "fmi2SetFMUstate not implemented");
    return fmi2Error;
}

fmi2Status osi_fmi2_free_fmu_state(fmi2Component c, fmi2FMUstate* FMUstate) {
    OSU *osu = reinterpret_cast<OSU*>(c);
    LOG_CALL(osu, "fmi2FreeFMUstate not implemented");
    return fmi2Error;
}

fmi2Status osi_fmi2_serialized_fmu_state_size(fmi2Component c, fmi2FMUstate FMUstate,
                                          size_t* size) {
    OSU *osu = reinterpret_cast<OSU*>(c);
...
fmi2Status osi_fmi2_serialize_fmu_state(fmi2Component c, fmi2FMUstate FMUstate,
...
fmi2Status  osi_fmi2_de_serialize_fmu_state(fmi2Component c,
...
fmi2Status osi_fmi2_get_directional_derivative(fmi2Component c,
...
fmi2Status osi_fmi2_enter_event_mode(fmi2Component c)
{
	OSU *osu = reinterpret_cast<OSU*>(c);
...
fmi2Status osi_fmi2_new_discrete_state(fmi2Component  c, fmi2EventInfo* fmiEventInfo)
{
    OSU *osu = reinterpret_cast<OSU*>(c);
...
fmi2Status osi_fmi2_enter_continuous_time_mode(fmi2Component c)
{
...
fmi2Status osi_fmi2_completed_integrator_step(fmi2Component c,
...
fmi2Status osi_fmi2_set_time(fmi2Component c, fmi2Real time)
{
...
fmi2Status osi_fmi2_set_continuous_states(fmi2Component c, const fmi2Real z[],
                                      size_t nz)
{
	OSU *osu = reinterpret_cast<OSU*>(c);
...
fmi2Status osi_fmi2_get_derivatives(fmi2Component c, fmi2Real derivatives[], size_t nz)
{
...
fmi2Status osi_fmi2_get_event_indicators(fmi2Component c,
...
fmi2Status osi_fmi2_get_continuous_states(fmi2Component c, fmi2Real z[], size_t nz) {
...
fmi2Status osi_fmi2_get_nominals_of_continuous_states(fmi2Component c,
                                                  fmi2Real z_nominal[],
                                                  size_t nz)
{
...
fmi2Component osi_fmi2_me_instantiate( fmi2String    instanceName,
                                       fmi2Type      fmuType,
                                       fmi2String    fmuGUID,
                                       fmi2String    fmuResourceLocation,
                                       const fmi2CallbackFunctions* functions,
...
void osi_fmi2_me_free_instance(fmi2Component c)
{
	OSU *osu = reinterpret_cast<OSU*>(c);
...
fmi2Status osi_fmi2_get_clock(fmi2Component c,const fmi2Integer clockIndex[],size_t nClockIndex, fmi2Boolean tick[])
{
	 OSU *osu = reinterpret_cast<OSU*>(c);
...
fmi2Status osi_fmi2_get_interval(fmi2Component c, const fmi2Integer clockIndex[],size_t nClockIndex, fmi2Real interval[])
{
...
fmi2Status osi_fmi2_set_clock(fmi2Component c, const fmi2Integer clockIndex[], size_t nClockIndex, const fmi2Boolean tick[],const fmi2Boolean subactive[])
{
	 OSU *osu = reinterpret_cast<OSU*>(c);
...
fmi2Status osi_fmi2_set_interval(fmi2Component c,const fmi2Integer clockIndex[],size_t nClockIndex, const fmi2Real interval[])
{
	 OSU *osu = reinterpret_cast<OSU*>(c);
